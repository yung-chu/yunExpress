...
using Acrobat;
using LMS.Client.QuickPrint.Common;
...
namespace LMS.Client.QuickPrint
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            GetLocalPrinters().ForEach(p=>cbbFirstPrinter.Items.Add(p));

            GetLocalPrinters().ForEach(p => cbbSecondPrinter.Items.Add(p));
    ...
    {
        public WebBrowserEx(AutoResetEvent wait)
            : base()
        {
            this.Wait = wait;
            this.DocumentCompleted += webBrowserDocumentCompleted;
            this.ScriptErrorsSuppressed = true;
            this.Size = new System.Drawing.Size(553, 259);
            this.Url = new System.Uri("", System.UriKind.Relative);
        }
        ...
        {
            if ((base.Url.ToString()!="about:blank")&& base.ReadyState == WebBrowserReadyState.Complete&& !base.IsBusy)
            {
                Wait.Set();
            }
        }
