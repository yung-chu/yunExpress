...
namespace MQS_Tests.LtQueueService {
    ...
    public interface ILtQueue {
        ...
        MQS_Tests.LtQueueService.QueueModel Enqueue(string queueName, string value);
        ...
        MQS_Tests.LtQueueService.QueueModel Dequeue(string queueName);
        ...
        MQS_Tests.LtQueueService.QueueModel QueueLength(string queueName);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ILtQueueChannel : MQS_Tests.LtQueueService.ILtQueue, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LtQueueClient : System.ServiceModel.ClientBase<MQS_Tests.LtQueueService.ILtQueue>, MQS_Tests.LtQueueService.ILtQueue {
        ...
        public MQS_Tests.LtQueueService.QueueModel Enqueue(string queueName, string value) {
            return base.Channel.Enqueue(queueName, value);
        }
        
        public MQS_Tests.LtQueueService.QueueModel Dequeue(string queueName) {
            return base.Channel.Dequeue(queueName);
        }
        
        public MQS_Tests.LtQueueService.QueueModel QueueLength(string queueName) {
