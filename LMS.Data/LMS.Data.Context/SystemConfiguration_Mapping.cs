...
namespace LMS.Data.Context
{
    ...
    internal partial class SystemConfiguration_Mapping : EntityTypeConfiguration<SystemConfiguration>
    {
        public SystemConfiguration_Mapping()
        {                        
              this.HasKey(t => t.DictionaryID);        
              this.ToTable("SystemConfigurations");
              ...
              this.Property(t => t.ConfigurationKey).HasColumnName("ConfigurationKey").IsRequired().HasMaxLength(100);
