...
namespace LMS.Data.Context
{
    ...
    internal partial class OutTrackingLogInfo_Mapping : EntityTypeConfiguration<OutTrackingLogInfo>
    {
        public OutTrackingLogInfo_Mapping()
        {					
    		this.HasKey(t => t.ID);		
    		this.ToTable("OutTrackingLogInfos");
    		this.Property(t => t.ID).HasColumnName("ID");
    		this.Property(t => t.WayBillNumber).HasColumnName("WayBillNumber").HasMaxLength(50);
    		this.Property(t => t.CustomerCode).HasColumnName("CustomerCode").HasMaxLength(50);
    		...
    		this.Property(t => t.PackageState).HasColumnName("PackageState");
    		this.Property(t => t.IntervalDays).HasColumnName("IntervalDays");
    		...
    		this.Property(t => t.Remarks).HasColumnName("Remarks").HasMaxLength(50);
    	}
    }
}
