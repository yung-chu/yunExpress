...
namespace LMS.Data.Context
{
    ...
    internal partial class GoodsTypeInfo_Mapping : EntityTypeConfiguration<GoodsTypeInfo>
    {
        public GoodsTypeInfo_Mapping()
        {                        
              this.HasKey(t => t.GoodsTypeID);        
              this.ToTable("GoodsTypeInfos");
              this.Property(t => t.GoodsTypeID).HasColumnName("GoodsTypeID");
              this.Property(t => t.GoodsTypeName).HasColumnName("GoodsTypeName").HasMaxLength(10);
